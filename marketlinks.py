...
from app.models import User, Card, Product

app = create_app()

@app.shell_context_processor
def make_shell_context():
    return {'Town': Town, 'Nation': Nation, 'State': State, 'db': db, 'User': User, 'Place': Place, 'jsonify': jsonify, 'Forumpost': Forumpost, 'Product': Product, \
